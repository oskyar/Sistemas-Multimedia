...
/**
 * Elipse que implementa la interfaz IOShape para que todas las clases
 * personalizadas tengan los mismos atributos/métodos.
 *
 * ver {@link IOShape}, ver {@link Ellipse2D.Double}
 *
 * @author oskyar (Óscar Zafra)
 */
public class OEllipse2D extends Ellipse2D.Double implements IOShape {

    public static final String NAME = "Elipse";
    ...
    /**
     * Crea una elipse que implementa los métodos necesarios y contiene los
     * atributos para tener color, forma, gradientes, trazo propio.
     *
     * @param p1 primer punto para la creación de la elipse
    ...
    /**
     * Crea una elipse con dos puntos.
     *
