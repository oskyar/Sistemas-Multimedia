...
/**
 * Interfaz que sirve para complementar a las clases de tipo Shape,
 * contiene los métodos necesarios poder modificar los atributos propios de 
 * cada forma obligando a que todas las clases tengan los mismos métodos.
 * Atributos que obliga a crearse en las clases personalizadas (Breve explicación
 * de los atributos que hay y algunos métodos).
 * <ul>
...
public interface IOShape{
    ...
    /**
     * ArrayList de puntos auxiliares, no lo implementan toda las clases debido a que no
     * es estrictamente necesario, se usa en las clases con puntos de control. 
    ...
    /**
     * Método en el que se modifica una posición del ArrayList. {@link Point2D.Double}
    ...
    /**
     * Devuelve el número de puntos de control que tiene la figura. {@link Point2D.Double}
     * @return Devuelve un entero con el número de puntos de control de la figura.
     */
    public int getCtrlPoints();

    /**
     * Devuelve el tipo de trazo que tiene la figura. ver {@link Stroke}
     * @return Devuelve un entero con el tipo de Stroke. ver constantes {@link practicaFinal.Lienzo} 
     ...
     * @param strokeType Entero con el tipo trazo. ver constantes {@link practicaFinal.Lienzo} 
     */
    public void setStrokeType(int strokeType);
    
    /**
     * Devuelve el tipo de unión del trazo que tiene la figura. ver constantes {@link practicaFinal.Lienzo} 
     * @return Devuelve un entero con el tipo de Stroke. 
     */
    public int getStrokeJoinStyle();
    
    /**
     * Modifica el tipo de unión del trazo. ver constantes {@link practicaFinal.Lienzo} 
     * @param strokeJoin Entero con el tipo trazo.
     */    
    public void setStrokeJoinStyle(int strokeJoin);
    
    /**
     * Devuelve el tipo de final de línea del trazo que tiene la figura. ver constantes {@link practicaFinal.Lienzo} 
     * @return Devuelve un entero con el tipo de final de línea del trazo.
     */
    public int getStrokeCapStyle();

     /**
     * Modifica el tipo de final del trazo. ver constantes {@link practicaFinal.Lienzo} 
    ...
    /**
     * Devuelve el tipo de relleno de la figura (Ninguno, Liso ó Gradiente). {@link practicaFinal.Lienzo}
    ...
    /**
     * Devuelve el Color del gradiente, (el segundo color), el primero viene a ser
     * el color de relleno.
     * @return 
     */
     ...
     * @param g2d <code>Graphics2D</code> necesario para poder dibujar la figura.
     */
     ...
     * @return Devuelve <code>true</code> si el punto está contenido y <code>false</code> en caso contrario.
     */
