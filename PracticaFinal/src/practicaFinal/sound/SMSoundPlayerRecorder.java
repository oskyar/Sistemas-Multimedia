package practicaFinal.sound;

import java.io.File;
import javax.sound.sampled.*;

/**
 * Reproductor/Grabador de audio basado en la Java Sound API que une en una
 * misma clase los métodos de SMSoundPlayer y SMSoundRecorder.
 *
...
public class SMSoundPlayerRecorder implements SMPlayer, SMRecorder {
     ...
     *
     * IMPORTANTE: Este método no devuelve el control hasta que acaba la
     * reproducción (mientras haya datos que leer mediante las llamadas a
     * 'read'). Por este motivo, se aconseja llamarlo dentro de una hebra .
     */
     ...
     * por defecto (veánse constantes).
     *
     * IMPORTANTE: Este método debe llamarse dentro de una hebra (de lo
     * contrario, entraría en una grabación constante que nunca terminaría).
     */
